...
import { Search, TrendingUp, FileText, Link, Megaphone } from 'lucide-react';

const SEOAndAwarenessSection = () => {
  const strategies = [
    {
      icon: FileText,
  ...
  return (
    <section id="seo-awareness" className="py-24 relative bg-gradient-to-b from-transparent via-purple-950/20 to-transparent">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            2. Fueling the Funnel: <span className="text-gradient">SEO & Awareness Campaigns</span>
          </h2>
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Even the best engine needs fuel. We'll implement a multi-faceted strategy to fill your sales funnel with a steady stream of high-quality inbound traffic.
          </p>
        </motion.div>
...
export default SEOAndAwarenessSection;
